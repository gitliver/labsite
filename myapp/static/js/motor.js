function setUpMotor() {
	...
	// This function hides some tags in the html doc and enables qtips,
	// which explain the fields which pop up after the user submits a gene
...
function submitData() {
	...
	// This functions queries the db with an AJAX call when the user submits a gene
	// ( need to sanitize input? )

	// the URL to which to post
